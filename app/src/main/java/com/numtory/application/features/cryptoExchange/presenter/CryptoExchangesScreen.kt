...
import com.numtory.application.features.cryptoExchange.domain.enums.topCryptoSymbols
import com.numtory.application.features.cryptoExchange.presenter.components.table.CryptoPriceItem
...
import com.numtory.application.features.cryptoExchange.presenter.components.CryptoMarketAppbar
import com.numtory.application.features.cryptoExchange.presenter.components.CryptoExchangeStickyHeader
import com.numtory.application.features.cryptoExchange.presenter.marketOptions.AssetOptionsBottomSheetScreen
...
@Composable
fun CryptoExchangeList(navigator: DestinationsNavigator, viewModel: CryptoExchangeViewModel = koinViewModel()) {
